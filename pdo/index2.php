            ...
            <div class="row">
                <div class="box2">
                    <div class="col-lg-12">
                        ...
                        $condicion = "";
                        $parametros = array();
                        $localidad = Leer::request("localidad");
                        $precio = Leer::request("precio");
                        $superficie = Leer::request("superficie");
                        $habitaciones = Leer::request("habitaciones");
                        $ordenar = Leer::request("ordenar");

                        if ($precio != "" && ($localidad != "" || $superficie != "" || $habitaciones != "")) {
                        ...
                        if ($localidad != "" && ($superficie != "" || $habitaciones != "")) {
                        ...
                        if ($superficie != "" && $habitaciones != "") {
                            $condicion .= "superficie = :superficie and ";
                        ...
                        if ($habitaciones != "") {
                            $condicion .= " habitaciones = :habitaciones";
                        ...
                        <!--            <input type="text" name="idcasa" value="" size="30" id="idcasa" placeholder="idcasa" required/>
                            <br/>-->
                                    <fieldset>
                                        <legend>Filtrar datos</legend>
                                        <input type="text" name="localidad" value="" size="50" id="localidad" placeholder="localidad"/>
                                        <br/>
                                        <input type="text" name="precio" value="" size="50" id="precio" placeholder="precio"/>
                                        <br/>
                                        <input type="text" name="superficie" value="" size="50" id="superficie" placeholder="superficie"/>
                                        <br/>
                                        <input type="text" name="habitaciones" value="" size="50" id="habitaciones" placeholder="habitaciones"/>
                                        <br/>
                                    </fieldset>
                                    <fieldset>
                                        <legend>Ordenar viviendas</legend>
                                        <input type="radio" value="asc" name="ordenar" checked/> Ascendente<br/>
                                        <input type="radio" value="des" name="ordenar" /> Descendente<br/>
                                    </fieldset>
                                    <br/>
                                        ...
                                        foreach ($filas as $indice => $objeto) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a data-idcasa='<?php echo $objeto->getIdcasa(); ?>'
                                                       href='ver2.php?idcasa=<?php echo $objeto->getIdcasa(); ?>'>ver fotos</a>
                                                </td>
